    ...
    >
      <div>
        <Link href={"/admin"} className="flex items-center space-x-2 p-3 ">
          ...
          {visible && (
            <span className="tex-highlight-light dark:text-highlight-dark text-xl font-semibold leading-none">
              Admin
            </span>
          )}
        </Link>
        ...
        <div className="mt-5">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="flex items-center tex-highlight-light dark:text-highlight-dark text-xl p-3 hover:scale-[0.98] transition mb-2"
            >
              <item.icon size={24} />
      ...
      <button
        ...
        className="tex-highlight-light dark:text-highlight-dark p-3 hover:scale-[0.98] transition self-end"
      >
        {visible ? (
